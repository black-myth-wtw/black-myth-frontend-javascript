...
// ES5
// Function.prototype.call_mine = function (context) {
//     if (typeof this !== 'function') throw new TypeError(`当前方法必须被函数调用~~~~~~`);
//     var symbol = Symbol.for('call-mine'),
...
//
// ES6
// Function.prototype.call_mine = function (context, ...args) {
//     if (typeof this !== 'function') throw new TypeError(`当前方法必须被函数调用~~~~~~`);
//     const symbol = Symbol.for('call-mine');
//     context[symbol] = this;
