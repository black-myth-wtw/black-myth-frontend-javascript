...
//         var odd = {};
//         odd.promise = new Promise(function (resolve, reject) {
//             odd.resolve = resolve;
//             odd.reject = reject;
//         });
//         return odd;
...
// }, 0);
// console.log('I love ZhaoYue~~~~~~');
// MyPromise.resolve([1, 99, 100]).then(values => {
//     console.log(values);
// });
// // MyPromise.resolve([1, Promise.reject(99), 101]).then(values => {
// //     console.log(values);
// // }).catch(reason => {
// //     console.error('error:', reason);
// // });
...
//     console.log('error:', reason);
// });
// MyPromise.reject('I love complete promise~~~~~').then(value => {
//     console.log(value);
// }).catch(reason => {
//     console.log('error:', reason);
// });
...
//     resolve('I love FrontEnd~~~~~~')
// }), MyPromise.resolve(199), true]).then(values => {
//     console.log(values);
// }).catch(reason => {
//     console.error('error:', reason);
// });
// MyPromise.all([new MyPromise(resolve => {
//     resolve('I love FrontEnd~~~~~~')
// }), MyPromise.reject(777), true]).then(values => {
//     console.log(values);
// }).catch(reason => {
//     console.error('error:', reason);
// });
...
//         resolve('I love FrontEnd~~~~~~');
//     }, 4500);
// }), MyPromise.resolve(999), true]).then(values => {
//     console.log(values);
// }).catch(reason => {
//     console.error('error:', reason);
// });
