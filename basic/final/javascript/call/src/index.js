...
//     }
// };
// Person.call_mock(black_myth_wtw, 'black@myth@wtw', 28, false, '1968-01-28', {sports: ['basketball', 'computer games']});
// console.log(black_myth_wtw);
// Person.call_mock(this, 'black#myth#wtw', 24, true, '1994-03-10', {sports: ['tennis', 'table tennis']});
