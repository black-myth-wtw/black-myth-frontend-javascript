...
//     if (!source_class || !target_object || !source_class.prototype || !target_object.__proto__) {
//         throw new TypeError(`The current source_class:${source_class} and target_object:${target_object} have no structural relationship~~~~~~`);
//     }
